...
import { getSupabaseClientConfig, SupabaseClientConfig } from '../backend/supabase';
...
function supabaseReceiver(supabaseClientConfig: SupabaseClientConfig, spaceID: string, onPoke: () => Promise<void>) {
  if (!supabaseClientConfig) {
